...
(function () {
    ...
    css.textContent = '#_ep_{position:fixed;z-index:999999;width:430px;height:580px;background:#fff;border:1px solid #e8ebf0;border-radius:12px;box-shadow:0 10px 32px rgba(15,23,42,.16);font:12px/1.6 "Microsoft YaHei",sans-serif;color:#333;display:flex;flex-direction:column;overflow:hidden;user-select:none}#_ep_ .hd{display:flex;align-items:center;padding:0 12px;height:40px;background:linear-gradient(135deg,#1677ff,#4096ff);color:#fff;cursor:move;flex-shrink:0;gap:8px}#_ep_ .hd .dot{width:8px;height:8px;border-radius:50%;background:#cbd5e1;flex-shrink:0;transition:background .2s,box-shadow .2s}#_ep_ .hd .dot.on{background:#52c41a;box-shadow:0 0 0 3px rgba(82,196,26,.16)}#_ep_ .hd .dot.off{background:#ff4d4f;box-shadow:0 0 0 3px rgba(255,77,79,.16)}#_ep_ .hd b{flex:1;font-size:13px;font-weight:600;letter-spacing:.5px}#_ep_ .hd button{background:rgba(255,255,255,.14);border:1px solid rgba(255,255,255,.45);color:#fff;padding:2px 9px;border-radius:6px;cursor:pointer;font-size:11px;line-height:16px;transition:background .15s}#_ep_ .hd button:hover{background:rgba(255,255,255,.28)}#_ep_[data-mini="1"]{width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,#1677ff,#4c9dff);opacity:.92;overflow:hidden;box-shadow:0 6px 18px rgba(22,119,255,.3)}#_ep_[data-mini="1"]:hover{opacity:1;box-shadow:0 8px 22px rgba(22,119,255,.38)}#_ep_[data-mini="1"] .hd{height:44px;border-radius:50%;cursor:grab;justify-content:center;padding:0;background:transparent}#_ep_[data-mini="1"] .hd *{display:none}#_ep_[data-mini="1"] .hd::after{content:"效率";color:#fff;font-size:11px;font-weight:600;letter-spacing:1px}#_ep_ .bd{flex:1;overflow-y:auto;padding:0}#_ep_ .tabs{display:flex;border-bottom:1px solid #f0f2f5;flex-shrink:0;background:#fff}#_ep_ .tab{flex:1;padding:9px 4px;text-align:center;font-size:11px;cursor:pointer;color:#8c99ab;border-bottom:2px solid transparent;transition:color .15s,background .15s}#_ep_ .tab:hover{background:#f7f9fc;color:#5a6a80}#_ep_ .tab.active{color:#1677ff;border-bottom-color:#1677ff;font-weight:600}#_ep_ .tab-page{display:none;padding:10px 12px}#_ep_ .tab-page.active{display:block}#_ep_ .row{display:flex;align-items:center;margin-bottom:7px}#_ep_ .row label{width:76px;flex-shrink:0;font-size:11px;color:#6b7688}#_ep_ .row input,#_ep_ .row select{flex:1;min-width:0;border:1px solid #dfe4ec;border-radius:6px;padding:3px 7px;font-size:11px;outline:none;height:26px;background:#fff;color:#333;transition:border-color .15s,box-shadow .15s}#_ep_ .row input:focus,#_ep_ .row select:focus{border-color:#1677ff;box-shadow:0 0 0 2px rgba(22,119,255,.12)}#_ep_ .row input[readonly]{background:#f7f8fa;color:#8c99ab}#_ep_ .sep{border-top:1px dashed #e8eaef;margin:7px 0;font-size:10px;color:#bfbfbf;text-align:center;line-height:15px}#_ep_ .sep span{background:#fff;padding:0 8px;position:relative;top:-7px}#_ep_ .cks{display:flex;gap:12px;margin-bottom:5px;flex-wrap:wrap}#_ep_ .cks label{display:flex;align-items:center;gap:4px;font-size:11px;color:#5b667a;cursor:pointer}#_ep_ .cks input{width:auto;accent-color:#1677ff}#_ep_ .acts{display:flex;gap:6px;margin:6px 0;flex-wrap:wrap}#_ep_ .btn{padding:5px 12px;border:1px solid #dfe4ec;border-radius:6px;background:#fff;cursor:pointer;font-size:11px;color:#4a5568;transition:background .15s,color .15s,border-color .15s}#_ep_ .btn:hover{border-color:#1677ff;color:#1677ff;background:#f3f8ff}#_ep_ .btn.p{background:#1677ff;color:#fff;border-color:#1677ff}#_ep_ .btn.p:hover{background:#4096ff;border-color:#4096ff;color:#fff}#_ep_ .btn:disabled{opacity:.5;cursor:not-allowed}#_ep_ .btn.w{background:#fa8c16;color:#fff;border-color:#fa8c16}#_ep_ .btn.w:hover{background:#ffa940;border-color:#ffa940;color:#fff}#_ep_ .log{padding:5px 10px;background:#fafbfc;border-top:1px solid #f0f2f5;font:11px/1.6 Consolas,monospace;max-height:130px;overflow-y:auto;color:#8c99ab;flex-shrink:0;user-select:text}#_ep_ .log .ok{color:#52c41a}#_ep_ .log .er{color:#ff4d4f}#_ep_ .log .i{color:#1677ff}#_ep_ .log .w{color:#faad14}#_ep_ .tbl{width:100%;border-collapse:collapse;margin:4px 0;font-size:11px}#_ep_ .tbl th,#_ep_ .tbl td{border:0;border-bottom:1px solid #f0f2f5;padding:4px 6px;text-align:center}#_ep_ .tbl th{background:#f5f8ff;color:#1677ff;font-weight:600}#_ep_ .tbl td{color:#4a5568}#_ep_ .tbl tr:last-child td{border-bottom:0}#_ep_ .eff-bar{display:flex;align-items:center;gap:8px;margin:6px 0;font-size:11px;color:#6b7688}#_ep_ .eff-bar .bar{flex:1;height:10px;background:#eef1f6;border-radius:6px;overflow:hidden}#_ep_ .eff-bar .bar .fill{height:100%;border-radius:6px;transition:width .3s}#_ep_ .info{padding:5px 10px;background:#eaf4ff;border-left:3px solid #1677ff;border-radius:6px;font-size:11px;color:#0958d9;margin:4px 0}';
